...
class IMUDriverNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(f"Port name: {self.port_name}, Baud rate: {self.baud_rate}")

        # 启动IMU驱动线程
        self.driver_thread = threading.Thread(target=self.driver_loop, args=(self.port_name, self.baud_rate))
